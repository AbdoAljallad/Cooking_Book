...
class IngredientFormRow(QWidget):
    ...
    def _build_ui(self, units: list[tuple[int, str]]) -> None:
        ...
        self.name_en_input.setPlaceholderText("Ingredient name (English)")
        layout.addWidget(self.name_en_input, 0, 0, 1, 2)

        self.name_ar_input = QLineEdit()
        self.name_ar_input.setObjectName("searchInput")
        self.name_ar_input.setPlaceholderText("Ingredient name (Arabic, optional)")
        ...
        self.unit_combo.addItem("No unit", None)
        ...
        self.quantity_override_input.setPlaceholderText("Quantity override like 'to taste'")
        ...
        self.preparation_note_input.setPlaceholderText("Preparation note")
        layout.addWidget(self.preparation_note_input, 1, 3)

        self.scalable_checkbox = QCheckBox("Scalable")
